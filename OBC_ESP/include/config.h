...
#define LoRa_FREQUENCY_MHZ 420
#define COUNTDOWN_TIME 30 * 1000
...
#define MAIN_VALVE_REQUEST_STATE VALVE_CLOSE
#define UPUST_VALVE_REQUEST_STATE VALVE_CLOSE
#define MAIN_VALVE_COMMAND_TIME 0
#define UPUST_VALVE_COMMAND_TIME 0
